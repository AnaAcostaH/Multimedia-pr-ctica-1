...
var game = {
	...
	// boton volver en pagina de jugando
    backToLevelScreen: function(){
    ...
    // boton volver en pagina de seleccionar nivel
    backToHome: function(){
		game.showHomeScreen();
    },
...
var levels = {
	...
	data:[
		 {   // Primer nivel 
			...
			entities:[
				...
				{type:"villain", name:"villain4",x:520,y:205,calories:590},

				{type:"block", name:"wood", x:620,y:380,angle:90,width:100,height:25},
				{type:"block", name:"glass", x:620,y:280,angle:90,width:100,height:25},								
				{type:"villain", name:"villain7", x:620,y:205,calories:420},				

				{type:"hero", name:"bow",x:80,y:405},
				{type:"hero", name:"zapatilla",x:140,y:405},
			]
		 },
		{   // Segundo nivel
			...
			entities:[
				...
				{type:"villain", name:"villain6",x:715,y:155,calories:590},
				{type:"villain", name:"villain9",x:670,y:405,calories:420},
				{type:"villain", name:"villain8",x:765,y:400,calories:150},

				{type:"hero", name:"can",x:30,y:415},
		...
		{   // Tercer nivel
			...
			entities:[
				...
				{type:"block", name:"tube", x:820,y:380,angle:90,width:100,height:25},
				{type:"block", name:"tube", x:720,y:380,angle:90,width:100,height:25},
				{type:"block", name:"tube", x:620,y:380,angle:90,width:100,height:25},
				{type:"block", name:"glass", x:670,y:317.5,width:100,height:25},
				{type:"block", name:"glass", x:770,y:317.5,width:100,height:25},				
		...
		{   // Cuarto nivel
			...
			foreground:'cave-foreground',
			background:'volcano-background',
			entities:[
				...
				{type:"block", name:"iron", x:670,y:317.5,width:100,height:25},
				{type:"block", name:"iron", x:770,y:317.5,width:100,height:25},	
				...
				{type:"villain", name:"villain1",x:765,y:400,calories:450},
				{type:"villain", name:"villain2",x:670,y:405,calories:600},
				{type:"villain", name:"villain2",x:715,y:155,calories:600},
				{type:"villain", name:"villain3",x:570,y:415,calories:600},

				{type:"hero", name:"hammer",x:80,y:405},
	...
	init:function(){
		var html = "";
		html += '<div><img src="images/icons/return.png" id="returntohomescreen" onclick="game.backToHome();" alt="Go home"></div>';
	...
	load:function(number){
	   //Inicializar box2d world cada vez que se carga un nivel
		...
		//game.currentLevel.backgroundMusic = loader.loadSound("audio/"+level.music+".mp3");
